...
window.CheckoutView = ({ cart, cartTotal, discountAmount, appliedPromo, goBack, clearCart, changeRoute }) => {
    ...
    const POPULAR_CITIES = [
        "Київ", "Харків", "Одеса", "Дніпро", "Львів", "Запоріжжя", "Кривий Ріг", "Миколаїв", "Вінниця", "Херсон", "Полтава", "Чернігів", "Черкаси", "Житомир", "Суми", "Хмельницький", "Чернівці", "Рівне", "Кам'янське", "Кропивницький", "Івано-Франківськ", "Кременчук", "Тернопіль", "Луцьк", "Біла Церква", "Ужгород", "Нікополь", "Бровари", "Павлоград", "Умань", "Мукачево", "Ковель", "Калуш", "Коростень", "Стрий", "Коломия", "Бориспіль", "Ірпінь", "Буча", "Вишневе", "Боярка", "Обухів", "Фастів", "Переяслав", "Яготин", "Славутич", "Бердичів", "Новоград-Волинський", "Малин", "Кам'янець-Подільський", "Нетішин", "Славута", "Шепетівка", "Старокостянтинів", "Дубно", "Вараш", "Сарни", "Костопіль", "Здолбунів", "Острог", "Володимир", "Нововолинськ", "Дрогобич", "Червоноград", "Самбір", "Борислав", "Трускавець", "Новий Розділ", "Золочів", "Броди", "Сокаль", "Стебник", "Яворів", "Городок", "Винники", "Жовква", "Кам'янка-Бузька", "Дубляни", "Жидачів", "Ходорів", "Соснівка", "Великі Мости", "Радехів", "Сколе", "Буськ", "Турка", "Рава-Руська", "Перемишляни", "Судова Вишня", "Моршин", "Глиняни", "Бібрка", "Белз", "Угнів"
    ];
